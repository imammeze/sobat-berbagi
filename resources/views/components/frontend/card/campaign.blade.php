<div class="card border-0 card-campaign" onclick="window.location.href='{{ route('campaign.show', $campaign->slug) }}'">
    <img src="{{ asset($campaign->thumbnail) }}" class="card-img-top " alt="thumbnail-campaign">
    <div class="card-body p-2 d-flex flex-column justify-content-between">
        <h5 class="card-title">
            <a href="{{ route('campaign.show', $campaign->slug) }}" class="text-decoration-none text-dark">
                {{ $campaign->title }}
            </a>
        </h5>
