            ...
            <div class="col-md-6 grid-margin">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <h3 class="mb-2">
                            @php
                                $total = \App\Models\Campaign::where('mitra_id', auth()->user()->profile->id)->sum(
                                    'raised',
                                );
                            @endphp
            ...
            <div class="col-md-6 grid-margin">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <h3 class="mb-2">
                            {{ \App\Models\Campaign::where('mitra_id', auth()->user()->profile->id)->count() }}
                        </h3>
                    </div>
                </div>
            </div>
...
@php
    ...
    foreach (\App\Models\Campaign::where('mitra_id', auth()->user()->profile->id)->get() as $campaign) {
        $labels1[] = $campaign->title;
        $data1[] = $campaign->raised;
    }

    $total = \App\Models\Campaign::where('mitra_id', auth()->user()->profile->id)->sum('raised');
