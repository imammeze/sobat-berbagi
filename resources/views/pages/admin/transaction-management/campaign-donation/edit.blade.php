<x-layouts.admin>
    <div class="d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('admin.transaksi-campaign.index') }}" class="btn btn-danger btn-sm ml-auto mb-3">Kembali</a>
    </div>

    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <x-admin.card title="Edit Campaign">
                <form action="{{ route('admin.transaksi-campaign.update', $campaign->id) }}" method="POST"
